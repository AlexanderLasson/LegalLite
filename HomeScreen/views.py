...
def profile(request):
    ...
    TOSs_contributed = TOS.objects.filter(author = request.user)
    Edits_contributed = Edit.objects.filter(author = request.user)

    context = {
        'u_form': u_form, 'TOSs_contributed' : TOSs_contributed, 'Edits_contributed' : Edits_contributed,
    }
